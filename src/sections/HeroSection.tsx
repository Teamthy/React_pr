...
export default function HeroSection() {
    ...
    const specialFeatures = [
        "Free template to start instantly",
        "Setup in 10 minutes",
        "30 days free trial",
    ];
    ...
    return (
        <div className="relative flex flex-col items-center justify-center px-4 md:px-16 lg:px-24 xl:px-32">
            ...
            >
                Create LinkedIn Thumbnails That <span className="move-gradient px-3 rounded-xl text-nowrap">Stand Out. </span>
            </motion.h1>
            <motion.p className="text-base text-center text-slate-200 max-w-lg mt-6"
                ...
                transition={{ delay: 0.2, type: "spring", stiffness: 320, damping: 70, mass: 1 }}
            >
                No complexity. No noise. Just clean, customizable thumbnails to boost your personal brand.  
</motion.p>
            ...
            >
                <button onClick={() => navigate('/how-it-works')} className="flex items-center gap-2 border border-pink-900 hover:bg-pink-950/50 transition rounded-full px-6 h-11">
                ...
                <button className="bg-pink-600 hover:bg-pink-700 text-white rounded-full px-7 h-11">
                    Try 30 Days Free Trial (No credit card required)
                </button>
            </motion.div>
