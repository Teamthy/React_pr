...
export default function FeaturesSection() {
    return (
        <div id="features" className="px-4 md:px-16 lg:px-24 xl:px-32">
            <SectionTitle text1="Features" text2="What you’ll love" text3="Components, patterns and pages — everything you need to ship." />
            <div className="flex flex-wrap items-center justify-center gap-6 md:gap-4 mt-16 px-6">
                {featuresData.map((feature: IFeature, index: number) => (
                    ...
                    >
                        <div className="p-6 rounded-[13px] space-y-4 border border-slate-800 bg-slate-950 max-w-80 w-full">
                            {feature.icon}
            ...
            <div className="mt-40 relative mx-auto max-w-5xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 mt-8 gap-10">
                    ...
                    >
                        ...
                        <h3 className="text-[24px]/7.5 text-slate-300 font-medium mt-6">Better design. Higher engagement. Bigger impact. </h3>
                        <p className="text-slate-300 mt-2">Thumbnify empowers you to create stunning LinkedIn thumbnails that elevate your posts, drive engagement, and help your brand grow effortlessly.</p>
